...
a problem that is extraordinarily difficult, requiring novel ideas and techniques to 
...
\textcolor{red}{*The previous sentence has been modified 
so as to not contradict the ``wickedness'' of the problem.*} 
...
and there's still much more to do!}
 ...
 \textcolor{red}{Validation seems to be a significant challenge. But, prior to 
