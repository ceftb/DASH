...
if __name__ == "__main__":
    ...
    dict_one = {}
    dict_one[0] = "first item"
    dict_one[1] = "second item"

    dict_two = {}
    dict_two["key_one"] = "subitem one"
    dict_two["key_two"] = "subitem two"
    dict_two["3"] = [dict_one, dict_one]

    dict_two[2] = dict_one

    raw_data = json.dumps(dict_two)
    print raw_data
    ...
    for node_id in range(0, 1000000, 1):
        path_ = "/test/" + str(node_id)
        #zk.ensure_path(path_)
        # 800 bytes of data:
