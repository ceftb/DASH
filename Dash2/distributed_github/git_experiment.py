...
# A git experiment consists of a varying condition and for each condition a number of trials.
# GitExperiment uses GitTrial

class GitExperiment(object):
    def __init__(self, trial_class=Trial, independent=None, dependent=None, exp_data={}, num_trials=3,
                 file_output=None, hosts=None,
                 dash_home="/users/tregubov/projects/webdash",
                 imports="",
                 callback=None,
                 trial_class_str=None,
                 user="tregubov", start_hub=None):
        self.goal = ""
...
def run_local_part(**args):
    ...
    exp = GitExperiment(args['trial_class'] if 'trial_class' in args else Trial,
