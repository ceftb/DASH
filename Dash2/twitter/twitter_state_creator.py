...
class TwitterGraphBuilder(GraphBuilder):
    ...
    def update_nodes_and_edges(self, user_id, resource_id, root_resource_id, parent_resource_id, event_type, event_time):
        ...
        if self.graph.has_edge(resource_id, user_id):
            ...
            self.graph.get_edge_data(resource_id, user_id)['ef'] = [0] * len(twitter_events_list)
...
if __name__ == "__main__":
    ...
    create_initial_state_files(filename, TwitterGraphBuilder)
