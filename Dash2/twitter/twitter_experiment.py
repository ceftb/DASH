...
from Dash2.twitter.twitter_state_creator import TwitterGraphBuilder
from Dash2.socsim.network_utils import create_initial_state_files, IdDictionaryInMemoryStream
from Dash2.socsim.event_types import twitter_events_list, twitter_events
...
if __name__ == "__main__":
    ...
    domain = sys.argv[2]
    scenario = sys.argv[3]
    agent_class_name = sys.argv[4] # "TwitterAgent"
    agent_module_name = sys.argv[5] # "Dash2.reddt.twitter_agent"
    ...
    class TwitterTrial(SocsimTrial):
        parameters = [
                    ...
                    Parameter('platform', default="twitter"),
    ...
    if not os.path.isfile(initial_state_file_name):
        ...
        create_initial_state_files(input_event_log , TwitterGraphBuilder, twitter_events, twitter_events_list,
